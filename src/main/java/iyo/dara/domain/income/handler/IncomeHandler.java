package iyo.dara.domain.income.handler;

import iyo.dara.domain.income.query.IncomeQuery;
import iyo.dara.domain.income.service.IncomeService;
import iyo.dara.domain.income.write.IncomeWrite;
